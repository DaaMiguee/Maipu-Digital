      ...
      <div className="Footer__container">
        <div className="Footer__columnas">
          ...
          <div className="Footer__columna__uno">
            ...
            <div className="redes">
              {/* instagram */}
              <a href="https://www.instagram.com/maipu.digital/" target="blank">
                <svg
                  className="maipu__icon__redes"
